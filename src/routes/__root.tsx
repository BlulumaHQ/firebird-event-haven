...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Firebird Entertainment Theatre — Richmond's premier event venue" },
      {
        name: "description",
        content:
          "A flexible Richmond, BC event venue for concerts, conferences, cultural celebrations, dance competitions, graduations, and more. Professional production. Ample parking.",
      },
      { name: "author", content: "Firebird Entertainment Theatre" },
    ...
    links: [
      ...
      { rel: "icon", type: "image/png", href: "/__l5e/assets-v1/c5b35e4a-e58b-40e9-bdd8-0aea84667e0e/favicon.png" },
      { rel: "apple-touch-icon", href: "/__l5e/assets-v1/c5b35e4a-e58b-40e9-bdd8-0aea84667e0e/favicon.png" },
    ],
  }),
